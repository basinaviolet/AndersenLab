...
public class AliMainPage {
    ...
    @Step("setting the main value: language, currency and region")
    ...
    @Step("searching the product by pattern")
    ...
    //---------------- assertions --------------------
    @Step("check the settings (for tests)")
